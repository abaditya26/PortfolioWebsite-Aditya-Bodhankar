    ...
    <section id="projects" style="padding-top: 20px; padding-bottom: 20px;">
        <div class="container">
            <center>
                ...
                <div class="row-img-1 row" onclick="openfile('./viewimages.php?img=images/Aditya Bodhankar/projects/296825309137')" style="margin:10px; padding:20px;">
                    <div class="col-md-5">
                        <div class="from-left slide-in disappear">
                            <img src="images/background.jpg" class="img-projects">
                        </div>
                    </div>
                    <div class="col-md-5 from-right slide-in disappear" style="padding-top:20px">
                        <h5 class="">
                            Shield Website </h5>
                        <p class="">
                        </p>
                ...
                <br>
                <a href="./projects.php" class="btn-a">
                    <h3>+ <small>View More</small></h3>
                </a>
